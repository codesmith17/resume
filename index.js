...
if (isVercel) {
  ...
  app.listen(port, () => {
    ...
    console.log(`📊 Tracking link: http://localhost:${port}/track`);
    console.log(`📧 Email tracking: http://localhost:${port}/track-email?email=test@company.com&source=dev`);
    ...
    if (isDevelopment) {
      ...
      console.log('- No Google Sheets integration required');
      console.log('- All tracking data will be logged to console');
      console.log('- Set GOOGLE_CREDENTIALS env var for production mode');
    }
  });
} 